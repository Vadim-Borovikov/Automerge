...
namespace Automerger.Model.Tests
{
    public static class MergersCommonTests
    {
        public static void CommonTest(IChangeSetMerger merger)
        {
            ...
            MyAssert.Throws<ArgumentOutOfRangeException>(() => merger.Merge(changes1, changes2, new string[1]));
            merger.Merge(changes1, changes2, new string[2]);
        }

        public static void CheckDictionaries<T1, T2>(IDictionary<int, T1> expected, IDictionary<int, T2> actual)
        {
        ...
        internal static void CheckBothSides<T>(IChangeSetMerger merger, string[] source,
        ...
        internal static void CheckConflict(IChangeSetMerger merger, string[] source,
                                         IReadOnlyDictionary<int, IMergableChange> changes1,
                                         IReadOnlyDictionary<int, IMergableChange> changes2)
        {
